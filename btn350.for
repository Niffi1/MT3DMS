...
C
C
      SUBROUTINE BTN3RP(IN,IOUT,IUCN,IOBS,IMAS,ICNF,ICBM,NCOL,NROW,NLAY,
...
C
     ...
     &          RETA2(NCOL,NROW,NLAY,NCOMP),PRSITY2(NCOL,NROW,NLAY)
      ...
      DIMENSION TIMPRS(MXPRS),TMASIO(22,2,NCOMP),RMASIO(22,2,NCOMP),
...
C
     ...
     &          CWGT(NCOL,NROW,NLAY,NCOMP),RMASIO(22,2,NCOMP)
C
C--COPY CNEW TO CWGT
      DO K=1,NLAY
        DO I=1,NROW
...
C
     ...
     &          TMASIO(22,2,NCOMP),RMASIO(22,2,NCOMP),TMASS(4,3,NCOMP)
C
...
C--CORRECT FOR NET MASS FROM/INTO FLUID-STORAGE
      STRMAS=(TMASIO(18,1,ICOMP)+TMASIO(18,2,ICOMP))
   ...
   70 WRITE(IOUT,1110) NTRANS,KSTP,KPER
     ...
     &   WRITE(IOUT,1172) TMASIO(20,1,ICOMP),TMASIO(20,2,ICOMP)
      IF(TRNOP(4).AND.ISOTHM.GT.4) THEN
        ...
        WRITE(IOUT,1175) TMASIO(21,1,ICOMP),TMASIO(21,2,ICOMP)
        WRITE(IOUT,1176) TMASIO(22,1,ICOMP),TMASIO(22,2,ICOMP)
      ENDIF
