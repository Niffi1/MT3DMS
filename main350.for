...
C
     ...
     & IVER,LCSSMC)
C
      IF(TRNOP(4)) CALL RCT3AL(INRCT,IOUT,ISUM,ISUM2,NCOL,NROW,NLAY,
...
C
      IF(TRNOP(4)) CALL RCT3RP(INRCT,IOUT,NCOL,NROW,NLAY,NCOMP,IX(LCIB),
...
C
      IF(TRNOP(4))
     & CALL RCT3SV(NCOL,NROW,NLAY,NCOMP,ICOMP,IX(LCIB),X(LCPR),
...
C--UPDATE COEFFICIENTS THAT VARY WITH ITERATIONS
     ...
     & CALL RCT3CF(NCOL,NROW,NLAY,NCOMP,ICOMP,IX(LCIB),
...
C
      IF(TRNOP(3) .AND. ICOMP.LE.MCOMP)
     & CALL SSM3FM(NCOL,NROW,NLAY,NCOMP,ICOMP,IX(LCIB),
...
C
      IF(TRNOP(4)) CALL RCT3FM(NCOL,NROW,NLAY,NCOMP,ICOMP,IX(LCIB),
...
C
      IF(TRNOP(3) .AND. ICOMP.LE.MCOMP)
     & CALL SSM3BD(NCOL,NROW,NLAY,NCOMP,ICOMP,IX(LCIB),
     ...
     & DTRANS,ISS,RMASIO)
C
      IF(TRNOP(4)) CALL RCT3BD(NCOL,NROW,NLAY,NCOMP,ICOMP,IX(LCIB),
...
C--CALCULATE GLOBAL MASS BUDGETS AND CHECK MASS BALANCE
      CALL BTN3BD(KPER,KSTP,N,NCOL,NROW,NLAY,NCOMP,ICOMP,ISS,IX(LCIB),
