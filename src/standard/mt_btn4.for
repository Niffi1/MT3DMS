...
C
     ...
     &          NCOMP,MCOMP,I,NODES,IERR,MXCOMP,iNameFile
      LOGICAL   TRNOP(10),TRNOP_Temp(10)
...
C--IGNORE TRANSPORT OPTIONS INPUT IF ALREADY DEFINED THROUGH NameFile
      DO I=1,10
        TRNOP_Temp(I)=.FALSE.
      ENDDO
      READ(INBTN,'(10L2)',ERR=100) (TRNOP_Temp(I),I=1,10)
  100 IF(iNameFile.EQ.0) THEN
        DO I=1,10
          TRNOP(I)=TRNOP_Temp(I)
        ENDDO
      ENDIF
      WRITE(IOUT,1020)
...
C
C
      SUBROUTINE BTN4RP(IN,IOUT,IUCN,IUCN2,IOBS,IMAS,ICNF,ICBM,NCOL,
...
C
     ...
     & TIME2,CNEW,MIXELM,NCOUNT,NPINS,NRC,NPCHEK,
     & ISOTHM,RETA,SRCONC,TMASIN,TMASOT,
...
C
     ...
     &          K,I,J,N,NPRMAS,ICBUND,NCOMP,ICOMP
